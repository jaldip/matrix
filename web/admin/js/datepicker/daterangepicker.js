! function(t, e) {
    ...
    s.prototype = {
        ...
        updateInputText: function() {
            var currentDate = $('single_cal3').val();
            ...
            var previousDateStr = $('input').val();
            var previousDateArr = previousDateStr.split("/");
            var day = previousDateArr[0];
            var month = previousDateArr[1]-1;
            var year = previousDateArr[2];
            var previousDate = new Date(year,month,day);
