...
class homeController {
    ...
    public function callAddEditEsp() {
        ...
        $sEsp = isset($aEspListData[$nLastRecordCount]['esp']) ? $aEspListData[$nLastRecordCount]['esp'] : '';
        $sDomainGroupedByEsp = isset($aEspListData[$nLastRecordCount]['domain_grouped_by_esp']) ? $aEspListData[$nLastRecordCount]['domain_grouped_by_esp'] : ''; 
        $sSuccess = isset($aEspListData[$nLastRecordCount]['success']) ? $aEspListData[$nLastRecordCount]['success'] : ''; 
        $nOpenPercentage = isset($aEspListData[$nLastRecordCount]['open_percentage']) ? $aEspListData[$nLastRecordCount]['open_percentage'] : ''; 
        $nClick = isset($aEspListData[$nLastRecordCount]['clicks']) ? $aEspListData[$nLastRecordCount]['clicks'] : '';
        $nComplaints = isset($aEspListData[$nLastRecordCount]['complaints']) ? $aEspListData[$nLastRecordCount]['complaints'] : ''; 
        $nComplaintsRate = isset($aEspListData[$nLastRecordCount]['complaints_rate']) ? $aEspListData[$nLastRecordCount]['complaints_rate'] : ''; 
