...
<head>
  ...
  <link href="<?php echo getConfig('siteUrl') . '/fonts/css/font-awesome.min.css';?>" rel="stylesheet">
  <link href="<?php echo getConfig('siteUrl') . '/css/animate.min.css';?>" rel="stylesheet">
  <link href="<?php echo getConfig('siteUrl') . '/css/custom.css';?>" rel="stylesheet">
  <link href="<?php echo getConfig('siteUrl') . '/css/icheck/flat/green.css';?>" rel="stylesheet">
...
<body class="nav-md">
  ...
  <script src="<?php echo getConfig('siteUrl') . '/js/progressbar/bootstrap-progressbar.min.js';?>"></script>
  <script src="<?php echo getConfig('siteUrl') . '/js/nicescroll/jquery.nicescroll.min.js';?>"></script>
  <script src="<?php echo getConfig('siteUrl') . '/js/icheck/icheck.min.js';?>"></script>
  <script src="<?php echo getConfig('siteUrl') . '/js/custom.js';?>"></script>
  <!-- pace -->
  <script src="<?php echo getConfig('siteUrl') . '/js/pace/pace.min.js';?>"></script>
